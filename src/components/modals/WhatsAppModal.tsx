...
export default function WhatsAppModal({
  ...
  const messageTemplates = {
    saludo: `${getGreeting()} ${
      contact.nombre
    }, soy del equipo de La Libertad Avanza. ¿Cómo está usted?`,
    recordatorio: `${getGreeting()} ${
      contact.nombre
    }, le escribo desde La Libertad Avanza para recordarle sobre nuestras próximas actividades.`,
    ...
    consulta: `${getGreeting()} ${
      contact.nombre
    }, desde La Libertad Avanza queremos conocer su opinión sobre los temas que nos ocupan.`,
      ...
      <div className="space-y-6">
        ...
        <div className="bg-gray-50 rounded-lg p-4">
          ...
          <div className="text-sm text-gray-600 space-y-1">
            <p>
              📱 Teléfono: <b>{contact.telefono}</b>
            </p>
            <p>
              📱 Tel. Alt:<b>{contact.telefono2}</b>
            </p>
            <p>
              ✉️ E-Mail: <b>{contact.email}</b>
            </p>
            <p>
              📍 Localidad: <b>{contact.localidad}</b>
            </p>
            <p>
              🆔 DNI: <b>{contact.dni}</b>
            </p>
            <p>
              👤 ¿Función?: <b>{contact.rol}</b>
            </p>
            <p>
              ⚧ Genero: <b>{contact.genero}</b>
            </p>
            <p>
              💼 Experiencia: <b>{contact.experiencia}</b>
            </p>
            <p>
              💬 Preferencias: <b>{contact.preferencias}</b>
            </p>
            ...
            {[
              {
                ...
                desc: "Mensaje de presentación y saludo",
              },
              {
                value: "recordatorio",
                label: "Recordatorio",
              ...
              },
              {
                value: "invitacion",
                label: "Invitación",
                desc: "Invitación a eventos o actividades",
              },
              {
                value: "consulta",
                label: "Consulta",
                desc: "Consulta de opinión o feedback",
              },
              {
                value: "seguimiento",
                label: "Seguimiento",
        ...
        <div className="text-xs text-gray-500 bg-blue-50 p-3 rounded-lg">
          ...
          abrirá la aplicación de WhatsApp con el mensaje prellenado. Podrás
          revisar y modificar el mensaje antes de enviarlo definitivamente. El
          estado del contacto se actualizará automáticamente a "Comunicado".
        </div>
      </div>
    </Modal>
  );
